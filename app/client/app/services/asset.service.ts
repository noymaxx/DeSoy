...
export const createAsset = async (
    ...
    try {
        ...
        if (
            ...
            throw new Error(
                "Missing required fields: assetType, quantity, pricePerUnit, expectedHarvestDate, or expectedDeliveryDate"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "Missing required location fields: latitude, longitude, or address"
            );
        }
