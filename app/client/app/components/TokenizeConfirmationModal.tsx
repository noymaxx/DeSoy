...
export default function TokenizeConfirmationModal({
    ...
    const handleConfirm = async () => {
        try {
            ...
            setIsProcessing(false);
            setError(
                error.message || "Failed to create asset or send transaction"
            );
            console.error(
                "Asset creation or blockchain interaction failed:",
                error
            );
        }
    };
                        ...
                        {isCompleted ? (
                            ...
                            >
                                ...
                                <p className="text-gray-300 mb-4">
                                    Your {formData.assetType} project has been
                                    successfully tokenized and is now available
                                    for investment.
                                </p>
                                <p className="text-sm text-gray-400">
                                    Investors can now discover and fund your
                                    project. You'll receive notifications when
                                    funding milestones are reached.
                                </p>
                            </motion.div>
                        ) : (
                            <motion.div
                            ...
                            >
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-400">
                                        Please confirm all information before
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div className="mt-4 pt-4 border-t border-gray-700">
                                            <div className="text-xs text-gray-400 space-y-1">
                                                ...
                                                <p>
                                                    • Project will be validated
                                                    by Chainlink oracles
                                                </p>
                                                <p>
                                                    • Funding period: Until
                                                    harvest date or fully funded
                                                </p>
                                            </div>
                                        </div>
                                    </CardContent>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="text-sm">
                                            ...
                                            <p className="text-gray-300">
                                                By publishing this project, you
                                                agree to the platform terms and
                                                commit to repaying investors
                                                according to the agreed terms.
                                                All information provided will be
                                                verified by our oracle network.
                                            </p>
                                        </div>
                                    </div>
                                </div>
