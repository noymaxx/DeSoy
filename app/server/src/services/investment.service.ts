...
export class InvestmentService {
  ...
  async createInvestment(data: {
    ...
    investorId: string;
    amount: number;
  }): Promise<{ investment: Investment; asset: Asset; transaction: Transaction }> {
    ...
    try {
      ...
      if (data.amount > remainingFunding) {
        throw createError('Investment amount exceeds remaining funding needed', 400);
      }
